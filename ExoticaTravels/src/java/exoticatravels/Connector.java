...
public class Connector
{
    public Connection createConnection() throws NamingException, SQLException
        {
          //Connector dc = new Connector(); why this one is not working after implementing the class in DataSource
            ...
            ctx.rebind("jdbc/MyDB", dc); //why the rebind it instead binding??
